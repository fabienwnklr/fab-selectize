...
import { FabLoadCallback } from "./types/index";
 ...
 *
 */
export const loadDebounce = (fn: (value: string, callback: FabLoadCallback) => void, delay: number) => {
    var timeout: null | ReturnType<typeof setTimeout>;
    return function (this: FabSelectize, value: string, callback: FabLoadCallback) {
        var self = this;
