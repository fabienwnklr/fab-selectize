...
const config = {
  ...
  organizationName: 'fab-selectize', // Usually your GitHub org/user name.
  projectName: 'fab-selectize', // Usually your repo name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          //   position: 'right',
          // },
          { href: 'https://github.com/fabienwnklr/fab-selectize/discussions', label: 'Community', position: 'right' },
          { href: 'https://github.com/fabienwnklr/fab-selectize', label: 'GitHub', position: 'right', },
        ],
      },
      footer: {
        style: 'dark',
        ...
        links: [
          ...
          },
          {
            ...
            items: [
              {
                label: 'GitHub',
                href: 'https://github.com/fabienwnklr/fab-selectize',
              },
              {
                label: "Keybase",
        ...
        copyright: `Copyright © ${new Date().getFullYear()} FabSelectize team.`,
      },
      prism: {
