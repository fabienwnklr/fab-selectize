  ...
  return (
    <>
      ...
      <div className='pt-2 pb-2'>
        ...
        <button type="button" className="activate" id="select-children-activate">FabSelectize</button>
      </div>
...
<button type="button" class="activate" id="select-children-load">Load</button>
  <button type="button" class="activate" id="select-children-activate">FabSelectize</button>
