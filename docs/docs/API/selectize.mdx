...
<a name="FabSelectize"></a>

## FabSelectize($input, settings)
FabSelectize instance

**Kind**: global function  

| Param | Type | Description |
| --- | --- | --- |
| $input | <code>JQuery</code> | Jquery object of target element to FabSelectized |
...
| Param | Type |
| --- | --- |
| e | <code>object</code> | FabSelectize
