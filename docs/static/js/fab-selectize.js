...
const fabSelectize_default = "";
let instance_i = 0;
class FabSelectize extends MicroPlugin(MicroEvent) {
  constructor(input_arg, user_settings) {
    super();
    __publicField(this, "control_input");
    __publicField(this, "wrapper");
    __publicField(this, "dropdown");
    __publicField(this, "control");
    __publicField(this, "dropdown_content");
    __publicField(this, "focus_node");
    __publicField(this, "order", 0);
    __publicField(this, "settings");
    __publicField(this, "input");
    __publicField(this, "tabIndex");
    __publicField(this, "is_select_tag");
    __publicField(this, "rtl");
    __publicField(this, "inputId");
    __publicField(this, "_destroy");
    __publicField(this, "sifter");
    __publicField(this, "isOpen", false);
    __publicField(this, "isDisabled", false);
    __publicField(this, "isRequired");
    __publicField(this, "isInvalid", false);
    // @deprecated 1.8
    __publicField(this, "isValid", true);
    __publicField(this, "isLocked", false);
    __publicField(this, "isFocused", false);
    __publicField(this, "isInputHidden", false);
    __publicField(this, "isSetup", false);
    __publicField(this, "ignoreFocus", false);
    __publicField(this, "ignoreHover", false);
    __publicField(this, "hasOptions", false);
    __publicField(this, "currentResults");
    __publicField(this, "lastValue", "");
    __publicField(this, "caretPos", 0);
    __publicField(this, "loading", 0);
    __publicField(this, "loadedSearches", {});
    __publicField(this, "activeOption", null);
    __publicField(this, "activeItems", []);
    __publicField(this, "optgroups", {});
...
function virtual_scroll() {
  ...
  const clearFilter = (_option, value) => {
